...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Comparison of averaged SBs records subjecting to different pandemic periods between 2019 and 2020.}
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Relationships between aggregated SBs records and confirmed cases during the quarantine period.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/legend7.eps}
    \end{subfigure}
    \caption{Relationships between aggregated SBs records and confirmed cases during the mitigation period.}
