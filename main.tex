...
Detailed information in the behavior of residents during epidemic benefits the emergency management when one tries to design intervention strategies and resilience measures.
...
Although share bike usages has been applied in many sectors, they are rarely reported in pandemic researches.
Based on long time sequenced share bike records collected in Beijing, we analyzed the spatiotemporal behavior patterns of local residents, figured out the key time nodes of different pandemic periods and demonstrated the mobility reductions due to the onset of the COVID-19 threat and administrative restrictions. 
...
Discussions with evolving confirmed COVID-19 cases suggest the effectiveness and necessity of the public interventions in the COVID-19 containment during resilience period.
...
=======
>>>>>>> 55e88c4596f18f7e323e10d07dcc6dc75b48810c
...
In Figure \ref{fig:BSS_companies}, tech companies are crowded in the northwest of Beijing which take the biggest share bike usage.
...
As can be seen from the share bike usage of 16 Jan in Figure \ref{fig:BSS_communities}, the infected RAs are actually situated in the city center, with huge pedestrian flow rate surrounded by massive share bikes.
