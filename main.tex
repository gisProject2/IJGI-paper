...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_21.eps}};%-eps-converted-to.pdf}};
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_25.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{25 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_30.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{30 Jan}
    \end{subfigure}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_04.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{04 Feb}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_08.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{08 Feb}
    \end{subfigure}
    \begin{subfigure}{.15\textwidth}
        \includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/legend5-eps-converted-to.pdf}%legend7-eps-converted-to.pdf}
    \end{subfigure}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_12.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{12 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_17.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{17 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_20.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{20 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_24.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{24 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_28.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{28 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \mainBasic{Main_basic2.png}
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_29.eps}};%-eps-converted-to.pdf}};
            \legendBar{Scalebar_basic2.eps}
        \end{tikzpicture}
        \caption{29 Feb}
