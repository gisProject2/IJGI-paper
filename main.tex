...
Based on long time-sequenced share bike records collected in Beijing, we analyzed the spatiotemporal behavior patterns of residents, figured out the key time nodes of different pandemic periods, and demonstrated the variations in mobility due to the onset of the COVID-19 threat and administrative restrictions. 
