...
Traditional geospatial tools such as PostGIS\footnote{\url{https://postgis.net/}} or QGIS\footnote{\url{https://qgis.org/}} are no longer able to deal with large-scale spatial queries huge amount of BSS spatiotemporal data (66.8GB) due to limited of computer performance of stand-alone machine.
The computation in this paper was done on a computing cluster consisting of 5 machines with Intel(R) Xeon(R), CPU E5-2640 v2 @2.00GHz, 8 cores, 61.7GB memory, 20480KB cache. 

\subsection{Co-location Analysis}
...
This part aims at characterizing the behavior patterns of disease-spreading individuals by evaluating share bike usages concerning different pandemic periods.%thus provide references for authorities to gradually lift the most restrictive measures with more precision and confidence.
