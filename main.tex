...
The changes in citizens' behavior of different pandemic phase can be inferred from the co-location analysis between the BSS patterns and facilities locations, which provides insight into the evolving COVID-19 progress and the public response  
...
Moreover, due to the limited emerging understanding of the new virus and its transmission mechanisms, it remains challenging to reveal its impacts in \textcolor{red}{residents' daily lives}.
...
This part aims at characterizing the behavior patterns of disease-spreading individuals by evaluating SB usages with respect to different pandemic periods.%thus provide reference for authorities to gradually lift the most restrictive measures with more precision and confidence.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Relationships between cycling activities and POIs}
