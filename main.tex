...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.28\textwidth}
        ...
        \caption{Difference image of \textbf{phase a}}\label{fig:p_a_dif}
    \end{subfigure}
        \begin{subfigure}{.28\textwidth}
        \includegraphics[width=\textwidth]{Figures/BSSMinusmp2.eps}
        \caption{Difference image of \textbf{phase b}}\label{fig:p_b_dif}
    \end{subfigure}
        \begin{subfigure}{.28\textwidth}
        \includegraphics[width=\textwidth]{Figures/BSSMinusmp3.eps}
        \caption{Difference image of \textbf{phase c}}\label{fig:p_c_dif}
    \end{subfigure}
    \begin{subfigure}{.14\textwidth}
