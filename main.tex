...
Among hundreds of categories, we chose six mid ones: RA, high-tech company, other company, subway station, shopping plaza and supermarkets which correspond to productive and social activities.
...
To assess the overall behavior pattern changes, we picked out the infected RAs (see Figure \ref{fig:locations_of_confirmed_cases}) which are collected from the daily update on the novel coronavirus pneumonia outbreak dashboard\footnote{\url{http://wjw.beijing.gov.cn/xwzx_20031/wnxw/202003/t20200305_1679143.html} (as of March 05, 2020, in Chinese)} provided by National Health Commission of the People's Republic of China.  
...
To characterize the behavior patterns, we first selected the following important referential dates: 
\begin{table}[H]
    \centering
    \begin{tabular}{ll}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|l|l|l|l|}
        ...
        % \hline
        % Infected RA & 23 & 207.6 & 60.4 & 57.1 & 2.35\\
        % Infected RA & 20 & 35.8 & 15.6 & 15.5 & 1.66\\
        \hline
        RA & 5657 & 158.3 & 36.6 & 39.9 & 23.1\% & 109.0\%\\
        \hline
        High-tech company & 3858 & 200.4 & 36.3 & 41.1 & 18.1\% & 113.2\%\\
        \hline
        Other company & 32301 & 162.5 & 35.8 & 39.4 & 22.0\% & 110.1\%\\
        \hline
        Subway station & 137 & 113.8 & 29 & 31.7 & 25.5\% & 109.3\%\\
        \hline
        Shopping plaza & 217 & 168.9 & 38.4 & 41 & 22.7\% & 106.8\%\\
        \hline
...
Ratio $m/b$ shows that the bike usage of all categories decreased to one quarter, and high-tech companies dropped the most in both value and proportion, one possible explanation is they suit best ``work from home''. 
Ratio $a/m$ shows the bike usage of all categories have recovered to some extent after the partial restart of activities but far from the situation of usual time.

\subsection{Co-location Analysis with Infected RAs}

Like in Section \ref{sec:colo-poi}, we analyzed the share bike usage around infected RAs and that of surrounding RAs.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|l|l|l|l|}
        ...
        & & 01 Jan-21 Jan ($b$) & 22 Jan-09 Feb ($m$) & 10 Feb-01 Mar ($a$) & $m/b$ & $a/m$\\
        \hline
        Infected RA & 5657 & 158.3 & 36.6 & 39.9 & 23.1\% & 109.0\%\\
        \hline
        Surrounding RA & 3858 & 200.4 & 36.3 & 41.1 & 18.1\% & 113.2\%\\
        \hline
    \end{tabular}
    \caption{Bike usage in different phases infected RAs and that of surrounding RAs.
    %, where $c=(b+a)/2m$ is used to measure the bending of the evolution curve
    }
