...
In literature, behavior of residents since it were influenced by disasters
Under the threat of pandemic, behavior of residents seems to be highly influenced by various factors, such as disasterdisaster intensity, damage level, government inventions, news reports and etc.
...
%TODO 疫情的威胁程度直接影响居民出行，表现在behavior上的减弱；而居民的behavior is in association with 生产、经济活动，在已有研究中作为衡量灾后恢复的一项重要指标。
%在以往研究中，“行为模式在应急环境”由于能反应disaster阶段等多方面因素，而逐步被研究者重视，展开研究。下的意义，表现和尚存问题
population mobility pattern seem to be highly influenced by disaster states and various factors,
...
Figure \ref{fig:diagram} shows the work flow of our study.
...
\begin{enumerate}
	\item GeoSpark acts as an engine processing co-location analysis of POI and BSS data, and the result is aggregated and visualized by ArcGIS in the form of heatmap.
	\item Spark SQL is used to process temporal queries in BSS data then obtain mean, and standard error.
