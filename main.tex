...
%TODO a-c为2020的结果，d-f为2019的结果，由图可知，其对应的差值总体相差较小，且positive和negative的值相当，其差异可归结为用车的浮动，表明phase a下的人群活动基本一致。
...
Due to the COVID-19, 
%TODO 由于疫情的存在，phase b和c存在明显的差异，虽然时值春节假期，居民会有走亲访友及休闲娱乐的习惯，所以在（e）相对节前强度有所减弱，但在空间上仍存在high-intensity，相应在2020年，活动处于完全抑制的状态，两者间的差值更显著地凸出了疫情影响下，大量地出行需求出于安全地目的被减少，从而控制疾病传播。
%TODO phase c表明节后返工地情况，（f）显示往年假期之后活动将迅速恢复节前的正常水平，甚至可能会因新工作者的涌入而获得更强更广的mobility，但疫情影响下，虽然相对phase b有所回温，但整体恢复地较慢，年份之间的差异也展示了节后疫情对residents work and lives的持续影响。
Phase c 
...
It should also be highlighted that counts of accumulated confirmed cases stayed stable substantially across this period, suggesting effective containment of the spread of COVID-19 in the event of a resurgence in activities.  
