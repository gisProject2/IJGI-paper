...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_01_21.eps}};
        \end{tikzpicture}
        \caption{21 Jan}
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_01_25.eps}};
        \end{tikzpicture}
        \caption{25 Jan}
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_01_29.eps}};
        \end{tikzpicture}
        \caption{29 Jan}
    \end{subfigure}
        \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_02.eps}};
        \end{tikzpicture}
        \caption{02 Feb}
    \end{subfigure}
    ...
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_06.eps}};
        \end{tikzpicture}
        \caption{06 Feb}
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_10.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_14.eps}};
        \end{tikzpicture}
        \caption{14 Feb}
    \end{subfigure}
        \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_18.eps}};
        \end{tikzpicture}
        \caption{18 Feb}
    \end{subfigure}
    ...
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_22.eps}};
        \end{tikzpicture}
        \caption{24 Feb}
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_02_26.eps}};
        \end{tikzpicture}
        \caption{26 Feb}
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Overall_spatial_patterns/FN5_D2020_03_01.eps}};
        \end{tikzpicture}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSPhase1_2020.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSPhase2_2020.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSPhase3_2020.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSPhase1_2019.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSPhase2_2019.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSPhase3_2019.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node[opacity=0.8] at (a) {\includegraphics[width=\textwidth]{Figures/BSSMinusmp1.eps}};
        \end{tikzpicture}
    ...
    \end{subfigure}
    	...
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node[opacity=0.8] at (a) {\includegraphics[width=\textwidth]{Figures/BSSMinusmp2.eps}};
        \end{tikzpicture}
    ...
    \end{subfigure}
    	...
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node[opacity=0.8] at (a) {\includegraphics[width=\textwidth]{Figures/BSSMinusmp3.eps}};
        \end{tikzpicture}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_21.eps}};
        \end{tikzpicture}
        \caption{21 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_25.eps}};
        \end{tikzpicture}
        \caption{25 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_30.eps}};
        \end{tikzpicture}
        \caption{30 Jan}
    \end{subfigure}
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_04.eps}};
        \end{tikzpicture}
        \caption{04 Feb}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_08.eps}};
        \end{tikzpicture}
        \caption{08 Feb}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_12.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_17.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_20.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_24.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_28.eps}};
        \end{tikzpicture}
    ...
    \begin{subfigure}{.3\textwidth}
    	\begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_29.eps}};
        \end{tikzpicture}
