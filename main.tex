...
The changes in citizens' behavior subjecting to different pandemic phases can be inferred from the co-location analysis between the BSS patterns and facilities locations, which provides insight into the evolving COVID-19 progress and the public response  
