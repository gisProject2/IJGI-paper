...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/legend7.eps}
    \end{subfigure}
    \caption{Relationships between aggregated share bikes and confirmed cases when the epidemic is mitigated.}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
        \includegraphics[width=\textwidth]{Figures/AppendixLegend.eps}
        \caption{Legend}
    \end{subfigure}
