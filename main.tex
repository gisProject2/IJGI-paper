...
Having detailed information in the behavior of residents during epidemic benefits the emergency management when designing interventions and resilience measures.
From the perspective of movements, the widely used Bike Sharing System(BSS) in China is capable to characterize behavior patterns over time \& space within big cities, e.g., Beijing.
Although share bike usages has been applied in many sectors, they are rarely reported in pandemic management.
Based on long time sequenced share bike records collected in Beijing, the spatiotemporal behavior patterns of residents have been analyzed, figuring out the key time nodes to different pandemic periods and demonstrating mobility reductions due to the onset of the COVID-19 threat and administrative restrictions. 
The impact of pandemic on the productive and social activities was estimated by performing co-location analysis between behavior patterns and POIs.
