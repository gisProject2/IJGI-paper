...
Consistent with the changes detected in \ref{fig:hour_comparison_8} and \ref{fig:hour_comparison_18}, 
Before 21 Jan, 2020, share-bike activity is widely distributed throughout the city limits, but there is significant concentration in the downtown area, which is orange or even red in color, corresponding to high-intensity activities (up to 500-1000 records/hour).
...
Status continued until 09 Feb, when the spread of the COVID-19 was announced to be under control, and the productive and social activities were allowed to restart partially .
...
It should be noted that slight differences can be observed between weekdays and weekends.
