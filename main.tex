...
\end{enumerate}
By synthesizing the results above, we managed to reveal some behavior patterns of share bike usage.

\begin{figure}[ht]
    \centering
    \includegraphics[width=.7\textwidth]{diagram.pdf}
    \caption{Workflow chart}
    \label{fig:diagram}
\end{figure}

>>>>>>> 496d1dbeb5dc3f8500155e53d437fa6d0302825c
