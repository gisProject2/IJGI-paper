...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.28\textwidth}
    	\begin{tikzpicture}
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSMinusmp1.eps}};
        \end{tikzpicture}
    ...
    \end{subfigure}
    	...
    	\begin{tikzpicture}
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSMinusmp2.eps}};
        \end{tikzpicture}
    ...
    \end{subfigure}
    	...
    	\begin{tikzpicture}
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/BSSMinusmp3.eps}};
        \end{tikzpicture}
