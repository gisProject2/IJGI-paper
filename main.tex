...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=0.5]{RA_legend.eps}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=0.5]{Metro_legend.eps}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=0.5]{Malls_legend.eps}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=0.5]{IT Companies_legend.eps}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
