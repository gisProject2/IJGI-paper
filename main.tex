...
%=================================================================
\Title{Mining Behavior Patterns from Share Bike Usages during COVID-19 Pandemic: a Case Study in Beijing}
...
Based on long time-sequenced share bike records collected in Beijing, we analyzed the spatiotemporal behavior patterns of residents, figured out the key time nodes of different pandemic periods, and demonstrated the mobility reductions due to the onset of the COVID-19 threat and administrative restrictions. 
...
\keyword{Bike sharing system; COVID-19; behavioral pattern; spatiotemporal analysis; co-location analysis}
...
In this study, we use share bike usage records and the COVID-19 cases to measure period-wise spatiotemporal behavior patterns in Beijing. 
Identification of the key time nodes in different pandemic period is conducted by segmenting the whole time series while keeping the maximal similarity inside the segments.
Subjecting to different pandemic periods, co-location analysis is subsequently implemented between the usage patterns and different types of POIs, which reveals the public reactions and assess the impact of the COVID-19 pandemic.
Comparison between the patterns of 2019 and 2020 is considered to remove the effect of the Chinese New Year holiday. 
Finally, the effectiveness of suppression strategies is studied by comparing the change of behavior patterns to the progress of confirmed cases.
...
The main novelty of our proposed work is to depict public responses to the progress of COVID-19 from spatiotemporal perspective by the interpreting the behavior patterns of residents extracted from long time-sequenced share bike records. 
Therefore, the impact of the COVID-19 pandemic and the influence of suppression strategy could be analyzed in a citywide scale, providing references in more details for policy-making and epidemiology research. 

The remainder of this paper is organized as follows. 
Section \ref{sec:method} describes the study area and analysis methods.
Section \ref{sec:experimental results} reports the spatiotemporal change in behavior patterns regarding to the local COVID-9 progress and co-location analysis with POIs.
Discussions are presented in section \ref{sec:discussions} on comparison with previous year, and relation with confirmed cases during different pandemic periods.
...
This part aims at characterizing the behavior patterns of disease-spreading individuals by evaluating share bike usages concerning different pandemic periods.%thus provide reference for authorities to gradually lift the most restrictive measures with more precision and confidence.
