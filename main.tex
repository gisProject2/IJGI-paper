...
%=================================================================
\Title{Mining Behavior Patterns from Share Bike Usage during COVID-19 Pandemic: a Case Study in Beijing}
...
\abstract{During the epidemics of COVID-19, the whole world is experiencing a serious crisis on public health and the economy.
...
Although share bikes have been applied in many sectors, they are rarely reported in pandemic researches.
Based on long time-sequenced share bike records collected in Beijing, we constructed a behavior pattern analysis framework. 
With this two-thread framework, we analyzed the spatiotemporal behavior patterns of residents, figured out the key time nodes of different pandemic periods, and demonstrated the variations in mobility due to the onset of the COVID-19 threat and administrative restrictions. 
The impact of the pandemic on the productive and social activities was estimated by performing co-location analysis between behavior patterns and POIs.
...
These findings could provide critical information on how to respond to the current COVID-19 outbreak and other epidemic events.
}
...
Under the threat of pandemic, the activities of residents are inevitably influenced and restricted.
Since it is associated with productive and social activities, behavior of residents is used as one of the evaluation indicators for post-disaster reconstruction in literature \cite{Wang2016Research, Akter2019Big}.
Measuring changes in residents' behavior is urgent for enhancing emergency management and post-disaster recovery of current COVID-19 outbreak.
...
Available studies on human mobility patterns during disasters mainly focus on short-term emergencies(e.g. fires and earthquakes)\cite{Song2010Modelling,Song2014Prediction}.
Research on the dynamics of residents' behavior in a detailed scale during long-term pandemic is very limited.
...
Section \ref{sec:data} \& \ref{sec:method} describes the study area and proposed methods.
...
Figure \ref{fig:diagram} shows the work flow of our study to assess the reactions of residents to COVID-19 by above data sets.
To deal with large-scale spatial queries of huge amount of BSS spatiotemporal data (66.8GB), we made use of parallel computing all along the two main threads:
\begin{enumerate}
	\item GeoSpark acts as an engine processing co-location analysis of POI and BSS data, and the result is aggregated and visualized by ArcGIS in the form of heatmap. This thread is designed to quantify the spatial relationships between POIs and share bike usage. Details will be given in subsection \ref{sec:co-location}.
	\item Spark SQL is used to process temporal queries in BSS data then obtain mean, and standard error. This thread will identify key time nodes based on the changes of share bike usage corresponding to COVID-19 and explorate the temporal characteristics of share bike usage. Details will be given in subsection \ref{sec:phase_classification}.
...
By synthesizing the results above, we managed to reveal behavior patterns of share bike usage during pandemic.
Key algorithms to two threads are as follows. 
...
In this section, we present extensive experimental results of the spatiotemporal change in behavior patterns regarding the local COVID-9 progress, and association with POIs.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.23\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic1.png}};
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.28\textwidth}
        ...
        \end{tikzpicture}
        \caption{Difference between a and d}
        \label{fig:p_a_dif}
    \end{subfigure}
        \begin{subfigure}{.28\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
        ...
        \end{tikzpicture}
        \caption{Difference between b and e}
        \label{fig:p_b_dif}
    \end{subfigure}
        \begin{subfigure}{.28\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_21-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{21 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_25-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{25 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_01_30-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{30 Jan}
    \end{subfigure}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_04-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{04 Feb}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_08-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{08 Feb}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_12-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{12 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_17-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{17 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_20-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{20 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_24-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{24 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_28-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{28 Feb}
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Main_basic2.png}};
            \node at (a) {\includegraphics[width=\textwidth]{Figures/Relation_with_confrimed_cases/NewDistrictSSBD2020_02_29-eps-converted-to.pdf}};
        \end{tikzpicture}
        \caption{29 Feb}
...
It has been figured out that the cumulative confirmed cases stayed stable substantially after the restarting of productive activities, implying the ongoing control measures were necessary and effective in the containment of the spread of COVID-19 when opening-up.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            \node (a) {\includegraphics[width=\textwidth]{Appendix_basic.png}};
