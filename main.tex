...
During the period of epidemic mitigation, aggregated share bike usage gradually rebounded with stable accumulated confirmed cases, which can be inferred from Figure \ref{fig:correlation_02_12}- Figure \ref{fig:correlation_02_20}.
...
The difference is obvious when comparing weekdays to weekends.
A reduction in mobility on weekends could be inferred from comparison between Figure \ref{fig:correlation_02_24} and Figure \ref{fig:correlation_02_28}, which was attributed to the awareness of the risk of infection of residents.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.3\textwidth}
        ...
        \caption{16 Feb}\label{fig:correlation_02_16}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
