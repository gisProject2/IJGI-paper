...
Spatiotemporal behavior patterns can be reflected by share bike usage because great majority of Chinese citizens use share bikes to connect public transports and both ends of travel.
...
Xu et al. characterizes the BSS temporal flow and spatial distribution in Singapore \cite{xu2019unravel}.
...
\textbf{Contribution:} Our work aims at analyzing the differences between the patterns from the emergence of SARS-CoV-2 to the pandemic days and those of ordinary days in order to estimate the impact done by the epidemics.
Co-location, POI
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.7\textwidth}
        \includegraphics[width=\textwidth]{Figures/Fif2legend.eps}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/hour_8.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/hour_18.eps}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/2020phase1.eps}
        \caption{Before spring festival 2020}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/2020phase2.eps}
        \caption{Spring festival 2020}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/2020phase3.eps}
        \caption{After spring festival 2020}
    \end{subfigure}
    
    \vspace{6pt}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/2019phase1.eps}
        \caption{Before spring festival 2019}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/2019phase2.eps}
        \caption{Spring festival 2019}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/2019phase3.eps}
