...
Timeline of the outbreak of coronavirus \cite{li2020early}, huge impact on public health and all the domains of economy, from spring festival till today (March 2020).

Studies have been mostly conducted on epidemiology, e.g. transmission dynamics,  \cite{li2020early,chinazzi2020effect}, 

The 3rd generation of Bike Sharing System (BSS) emerges in China in 2015 thanks to rapid development of GIS-based and IT-based system. 
The 3rd BSS is no longer constrained by docking stations, thus covers more residents. 
As for city of Beijing, the number of sharebike reaches its peak in 2017 and people begins removing excess supply afterwards. 
The demand and the supply meet a balance in 2019, which reflects stable usage patterns of residents.
...
The datasets date from March 2018 to March 2020 and cover 1.5 million usages per day contributed by 11 million users which account for one half of the total population of Beijing.
Records contain the positioning and timing information of locking \& unlocking bikes, excluding that of rebalancing.
...
From the timeline \cite{li2020early} of the outbreak, we select the following important dates: 1.7 (Identification of 2019-nCoV) 1.24 (shut down of Wuhan and another 15 cities), 1.31 (End of national holiday of Chinese new year), 2.10 (end of extended holiday), restart of industries.
