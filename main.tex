...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.23\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=\scaleLegend]{Scalebar_basic1.eps}};
        \end{tikzpicture}
        \caption{21 Jan}
    \end{subfigure}
    \begin{subfigure}{.23\textwidth}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=\scaleLegend]{Scalebar_basic2.eps}};
        \end{tikzpicture}
        \caption{21 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=\scaleLegend]{RA_legend.pdf}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=\scaleLegend]{Metro_legend.pdf}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=\scaleLegend]{Mall_legend.pdf}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \begin{tikzpicture}[inner sep = 0pt]
            ...
            \node at (a.south west)[anchor=south west]{\includegraphics[scale=\scaleLegend]{Tech_companies_legend.pdf}};
        \end{tikzpicture}
        \caption{16 Jan}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
